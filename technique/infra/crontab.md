...
*/10 * * * * /usr/local/bin/gotcha-cron.sh /api/cron/check-devis-evidence >> /var/log/gotcha-devis-evidence.log 2>&1
15 0 * * * /usr/local/bin/gotcha-cron.sh /api/cron/seal-contract-evidence-daily >> /var/log/gotcha-evidence-seal.log 2>&1
20 0 * * * /usr/local/bin/gotcha-cron.sh /api/cron/seal-devis-evidence-daily >> /var/log/gotcha-devis-evidence-seal.log 2>&1
...
0 * * * * /usr/local/bin/gotcha-cron.sh /api/cron/auto-default-ratings >> /var/log/gotcha-auto-default-ratings.log 2>&1
