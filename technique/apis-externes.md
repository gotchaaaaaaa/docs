...
> **Derniere mise a jour** : Mai 2026 (commission 13% HT absorbed par le prestataire, frais Stripe absorbed, acompte 30%/800 EUR HT actif)
...
> Note : depuis l'inversion `42f78b7` (mai 2026), les frais Stripe sont **absorbes par le prestataire** (inclus dans `application_fee_amount`), tout comme la commission Gotcha 13% HT. L'entreprise paie strictement le TTC prestataire (`buildAbsorbedFeeChargeAmounts`). Voir `documentation/critique/paiement/fonctionnement.md`.
